import { useBookedTimeSlots } from "@/hooks/useAppointments";
...
const TimeSelectionStep = ({
    ...
    const { data: bookedTimeSlots = [], isLoading } = useBookedTimeSlots(selectedDentistId, selectedDate)

    const availableDates = getNext5Days();
    const availbaleTimeSlots = getAvailableTimeSlots()
        ...
        <>
            <div className="space-y-6">
                ...
                <div className="grid lg:grid-cols-2 gap-8">
                        ...
                        <div className="space-y-3">
                            {
                                APPOINTMENT_TYPES.map((type) => (
                                    <Card key={type.id} className={`cursor-pointer transition-all hover:shadow-sm ${selectedType === type.id ? "ring-2 ring-primary" : ""}`}
                    ...
                    <div className="space-y-4">
                        <h3 className="text-lg font-medium">Availbale Dates</h3>
