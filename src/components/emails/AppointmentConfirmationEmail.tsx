...
const AppointmentConfirmationEmail = ({ doctorName, appointmentDate, appointmentTime, appointmentType, duration, price }: AppointmentConfirmationEmailProps) => {
            ...
            <Body style={main}>
                <Container style={container}>
                    <Section style={logoContainer}>
                        <Img
                            src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRCxRKOfdYjefXHCTkwfCJcQ0owjFr2DXfjKQ&s"
                            width="50"
                            height="50"
                            alt="DentWise"
                            style={logo}
